        ...
        ***********************************-->
        <div class="nav-header">
            <a href="new-order.php" class="brand-logo">
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                        	<li class="nav-item dropdown notification_dropdown">
                                <a class="new_orderLink" href="new-order.php">NEW ORDER</a>
                            </li>
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="new_orderLink" href="order-summary.php">Orders</a>
                            </li>
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="new_orderLink" href="kitchen-display.php">KITCHEN</a>
                            </li>
                            <li class="nav-item dropdown notification_dropdown">
                            ...
                            <li class="nav-item dropdown header-profile">
                            	<div class="profile">
								    <a href="logout.php">
								    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#3e4954" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M10 3H6a2 2 0 0 0-2 2v14c0 1.1.9 2 2 2h4M16 17l5-5-5-5M19.8 12H9"/></svg>
                            ...
                            <li class="nav-item dropdown header-profile">
                            	<div class="vertical">
								    <div class="slider_item"><a class="text-info" href="mailto:info@encoderesto.com"><i class="fa fa-envelope"></i> info@encoderesto.com</a></div>
								    <div class="slider_item"><a class="text-danger" href="tel:+91 98765 43210"><i class="fa fa-phone"></i> +91 98765 43210</a></div>
								    <div class="slider_item"><a class="text-danger" href="tel:0123456789"><i class="fa fa-phone"></i> +91 0123456789</a></div>
								</div>
                                <!-- <a class="nav-link" href="mailto:info@encoderesto.com"><i class="fa fa-envelope"></i> info@encoderesto.com</a> -->
                            </li>
