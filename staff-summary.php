								...
								<div class="table-responsive">
									<table id="example5" class="display mb-4 dataTablesCard staff_list">
										...
										<tbody>
											<tr>
												<td>1.</td>
												<td class="wspace-no">Ranjit Roy</td>
												<td>+91 98765 43210</td>
												<td>Shiv Mandir, Bagdogra</td>
												<td>Waiter</td>
												<td><i class="fa fa-inr"></i> 8000</td>
												<td>
													<div class="menulist_img">
														<img src="images/profile/small/pic1.jpg">
													</div>
												</td>
												<td>
													<div class="dropdown ml-auto">
														...
														<div class="dropdown-menu dropdown-menu-right">
															<a class="dropdown-item text-success" href="staff-details.php">
															<i class="fa fa-eye"></i>View
															</a>
															<a class="dropdown-item text-info" href="staff-edit.php">
															...
															<a class="dropdown-item text-black" href="staff-delete.php">
															<svg class="mr-3" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
